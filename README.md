...
"[CLICK HERE](https://github.com/alcandelario/bookaday/blob/master/BookADay.apk)" to try the demo Android version now! This assumes you can install apps from unknown sources.
